...
# ============================================================
STATS_SERVER_URL="https://github.com/moo-the-cow/moo-rist-hosting-native/raw/refs/heads/main/linux_arm64/StatsServer.tar.gz"
LIBRIST_URL="https://github.com/moo-the-cow/moo-rist-hosting-native/raw/refs/heads/main/linux_arm64/librist.tar.gz"
# ============================================================
...
./librist/tools/ristreceiver -v 6 -b 1800 -i "rist://@0.0.0.0:$RIST_RECEIVER_PORT?rtt-min=70&rtt-max=1200&username=$USERNAME&password=$PASSWORD" -o "rist://127.0.0.1:$LOOPBACK_PORT" -r "127.0.0.1:$STATS_PORT" -p $RIST_PROFILE &
RECEIVER_PID=$!
