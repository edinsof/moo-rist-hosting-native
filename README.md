...
**current version:** `libRIST library: 0.2.19-rc2-25-gc7a578d API version: 4.12.0`

**⚠️Please update to 0.2.19-rc2-25-gc7a578d or higher version if you use an earlier one, there has been a vital update by the author**
